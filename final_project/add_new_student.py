...
def register_student():
    ...
    while True:
        try:
            student_id = input("Enter student ID (8 digits) or 'B' to back: ")
    ...
    while True:
        try:
            student_name = input("Enter student name or 'B' to back: ")
            if student_id.upper() == 'B':
                return
    ...
    while True:
        try:
            student_contact = input("Enter student contact number (10-11 digits) or 'B' to back: ")
            if student_id.upper() == 'B':
                return
